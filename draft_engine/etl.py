...
# hero_a is the Team-Up anchor/primary hero from the source string.
# Preserve source order; do not sort heroes inside a Team-Up tuple.
# ---------------------------------------------------------------------------
TEAM_UPS: list[tuple[str, str, str, str | None]] = [
    # Current Team-Ups from Liquipedia Mechanics portal.
    # Use one tuple per valid activation path; "or" branches are separate rows.
    ("Arcane Order",                          "Dr. Strange",    "Scarlet Witch",  None),
    ("Arcane Order",                          "Dr. Strange",    "Magik",          None),
    ("Bestial Hunt",                          "Daredevil",      "Punisher",       None),
    ("Blade of Khonshu",                      "Moon Knight",    "Blade",          None),
    ("Blessing of the Kumiho",                "White Fox",      "Luna Snow",      None),
    ("Chilling Assault",                      "Luna Snow",      "Iron Fist",      None),
    ("Chilling Assault",                      "Luna Snow",      "Emma Frost",     None),
    ("Cosmic Cyclone",                        "Storm",          "Adam Warlock",   None),
    ("Deep Wrath",                            "Hela",           "Namor",          None),
    ("Divine Armory",                         "Angela",         "Thor",           None),
    ("Explosive Entanglement",                "Gambit",         "Magneto",        None),
    ("Explosive Entanglement",                "Gambit",         "Rogue",          None),
    ("Fastball Special",                      "Wolverine",      "Hulk",           None),
    ("Fastball Special",                      "Wolverine",      "Thing",          None),
    ("First Steps",                           "Human Torch",    "Thing",          None),
    ("Gamma Charge",                          "Hulk",           "Black Panther",  None),
    ("Gamma Charge",                          "Hulk",           "Thing",          None),
    ("Lucky Loan",                            "Black Cat",      "White Fox",      None),
    ("Lucky Loan",                            "Black Cat",      "Captain America", None),
    ("Mr. Pool's Interdimensional Toy Box",   "DpsPool",        "Jeff TLS",       None),
    ("Mr. Pool's Interdimensional Toy Box",   "DpsPool",        "Elsa Bloodstone",None),
    ("Mr. Pool's Interdimensional Toy Box",   "SupportPool",    "Jeff TLS",       None),
    ("Mr. Pool's Interdimensional Toy Box",   "SupportPool",    "Elsa Bloodstone",None),
    ("Mr. Pool's Interdimensional Toy Box",   "Tankpool",       "Jeff TLS",       None),
    ("Mr. Pool's Interdimensional Toy Box",   "Tankpool",       "Elsa Bloodstone",None),
    ("Parker Power-Up",                       "Peni Parker",    "Spider-Man",     None),
    ("Planet X Pals",                         "Groot",          "Rocket Raccoon", None),
    ("Planet X Pals",                         "Groot",          "Jeff TLS",       None),
    ("Primal Flame",                          "Phoenix",        "Wolverine",      None),
    ("Primal Flame",                          "Phoenix",        "Black Widow",    None),
    ("Psionic Mayhem",                        "Invisible Woman", "Dr. Strange",   None),
    ("Rocket Network",                        "Rocket Raccoon", "Star-Lord",      None),
    ("Rocket Network",                        "Rocket Raccoon", "Mr. Fantastic",  None),
    ("Stark Protocol",                        "Iron Man",       "Ultron",         None),
    ("Stark Protocol",                        "Iron Man",       "Squirrel Girl",  None),
    ("Stars Aligned",                         "Captain America", "Winter Soldier", None),
    ("Sword of Duality",                      "Cloak & Dagger", "Hawkeye",        None),
    ("Sword of Duality",                      "Cloak & Dagger", "Psylocke",       None),
    ("Symbiote Shenanigans",                  "Venom",          "Jeff TLS",       None),
    ("Symbiote Shenanigans",                  "Venom",          "Hela",           None),
    ("Vibrant Vitality",                      "Mantis",         "Groot",          None),
    ("Vibrant Vitality",                      "Mantis",         "Loki",           None),
]
