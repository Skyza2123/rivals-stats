...
# Hero abilities
# ---------------------------------------------------------------------------
# Source: api.dotgg.gg (Marvel Rivals data feed). This list is normalized to
# the hero names used in this repository (e.g. Hulk, Dr. Strange, Jeff TLS,
# and Deadpool role placeholders).
HERO_ABILITIES: dict[str, list[str]] = {
    "Adam Warlock": [
        "Regenerative Cocoon",
        "Quantum Magic",
        "Cosmic Cluster",
    ...
    "Black Widow": [
        ...
        "Reload",
        "Edge Dancer",
        "High-energy Kick Select",
        "High-energy Kick",
        "Fleet Foot",
        "Electro-plasma Explosion",
        "Plasma Cannon Fire",
        "Detector Bullet (toggle)",
        "惩罚者协同开镜射击",
        "LION'S LAUNCH",
        "FEROCIOUS THROW",
    ],
    "Blade": [
        ...
        "Reload",
        "Daywalker Dash",
        "Stepping Heavy Slash (sword Form)",
        "Bloodline Awakening",
        "Spinning Slash",
        "Thousand-fold Slash",
        "Scarlet Shroud",
    ...
    "DpsPool": [
        ...
        "Xp Management",
        "Photo-taking",
        "Dual Desert Eagles - Duelist",
        "Dual Desert Eagles - Duelist Upgraded",
        "Kick@$$ Katana - Duelist",
        "Kick@$$ Katana - Duelist Upgraded",
        "Headshot! - Duelist",
        "Headshot! - Duelist Upgraded",
        "Hazardous Hijinks - Duelist",
        "Hazardous Hijinks - Duelist Upgraded",
        "Magical Unicorn Shield!",
        "Magical Unicorn Shield! - Upgraded",
        "Deadpool In Your Area - Duelist",
        "Deadpool In Your Area - Duelist Upgraded",
        "Slice And Dice!",
        "Lock And Load!",
        "Skill Issue",
        "Skill Issue - Upgraded",
        "Pop Quiz!",
        "Pop Quiz! - Upgraded",
        "Comical Chaos",
    ],
    ...
    "Human Torch": [
        "Human Torch Basic Flight Ability",
        "Fire Cluster",
        "Plasma Body",
        "Blazing Blast",
        "Flaming Meteor",
    ...
    "Iron Fist": [
        "Wall Runner Detection",
        "Crane Leap",
        "Jeet Kune Do",
        "Jeet Kune Do - In Midair",
        "Jeet Kune Do - Ultimate On Ground",
        "Yat Jee Chung Kuen - Ultimate In Midair",
        "Dragon's Defense",
        "Yat Jee Chung Kuen",
        "Ultimate Yat Jee Chung Kuen",
        "Harmony Recovery",
        "Lunar Chi",
        "K'un-lun Kick",
        "Living Chi",
    ...
    "Iron Man": [
        "Fusion Boost",
        "Repulsor Blast",
        "Gamma Repulsor Blast",
        "Repulsor Blast Fire",
        "Unibeam",
        "Gamma Unibeam",
        "Unibeam Fire",
        "Hyper-velocity",
        "Overdrive - Hyper-velocity",
        "Micro-missile Barrage",
        "Overdrive - Micro-missile Barrage",
        "Armor Overdrive",
        "Gamma Overdrive",
        "Invincible Pulse Cannon",
        "Iron Man - Melee Normal Attack",
        "Nano State - Melee Normal Attack",
        "Iron Man - Reload",
        "Nano Tech",
    ],
    "Jeff TLS": [
    ...
    "Mr. Fantastic": [
        "Elastic Strength",
        "Inflated-standard Shapeshift",
        "Standard-distended Shapeshift",
        "Stretch Punch",
        "Inflated State Elastic Strike",
        "Distended Grip",
        "Distended Grip Additionally Activates Left-hand Attack",
        "Flexible Elongation",
        "Reflexive Rubber",
        "Reflexive Rubber: Standard Wall - Standard",
        "Brainiac Bounce",
    ],
    "Namor": [
        "Trident Of Neptune",
        ...
        "Tide Fall",
        "Aquatic Dominion",
        "Monstro Spawn - Normal Attack",
        "Monstro Spawn - Enhanced Water Blast",
        "Frozen Spawn",
        "Ice Monstro Spawn - Normal Attack",
        "Ice Monstro Spawn - Enhanced Water Blast",
        "Gamma Ray",
        "Ultra Beam",
        "Horn Of Proteus",
        "Gamma Charge",
    ...
    "Phoenix": [
        ...
        "Phoenix Ray - Pursuit",
        "Reload",
        "Phoenix's Punishment",
        "凤凰惩戒-追击",
        "Psionic Detonation",
        "Psionic Detonation - Pursuit",
        "Dark Ascent",
        "Telepathic Illusion",
        "Endsong Inferno",
    ],
    "Psylocke": [
        ...
        "Reload",
        "Light Boomerang Dart",
        "Dark Dagger",
        "Psychic Echoes",
        "Psionic Disc",
    ],
    "Punisher": [
        "The Punisher Switches Main Weapon",
        ...
        "The Punisher Back-mounted Missiles",
        "The Punisher Rifle - Melee Basic Attack",
    ],
    "Rocket Raccoon": [
        "Wild Crawl",
        "Bombard Mode",
    ...
    "Rogue": [
        ...
        "Southern Brawl",
        "Chrono Kick Combo",
        "Chrono Kick Combo: Follow-up",
        "Chrono Kick Combo: Ranged Attack",
        "Fatal Attraction",
        "Ability Absorption",
        "Heartbreaker",
        "Hearts As One",
    ...
    "Squirrel Girl": [
        "Burst Acorn",
        "Squirrel Girl Reload",
        "Squirrel Blockade",
        "Tail Bounce",
        "Mammal Bond",
        "Unbeatable Squirrel Tsunami",
        "Squirrel Girl - Melee Normal Attack",
    ],
    "Star-Lord": [
        "Element Guns",
        "Star-lord Reload",
        ...
        "Blaster Barrage",
        "Galactic Legend",
        "Galactic Legend Attack",
        "Galactic Legend Reload",
        "Melee Normal Attack",
    ],
    "Storm": [
        "Windrider",
...
def get_hero_abilities(hero_name: str) -> list[str]:
    """Return the known ability names for a hero (case-insensitive)."""
    key = (hero_name or "").strip()
    if key in HERO_ABILITIES:
        return HERO_ABILITIES[key]
    lower = key.lower()
    for name, abilities in HERO_ABILITIES.items():
        if name.lower() == lower:
            return abilities
    return []
