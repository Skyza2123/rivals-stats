    ...
    for hero in raw_heroes:
        ...
        for ability in hero.get("abilities", []):
            ...
            if isinstance(additional_fields, dict):
                keybind = str(additional_fields.get("Key") or "").strip()
            has_teamup_bonus = (
            ...
            source_type = "teamup" if is_teamup else ("ultimate" if is_ultimate else "ability")
            ...
            if description_key and description_key in description_to_name:
                ...
                if name.lower().endswith(SKIP_DUPLICATE_NAME_SUFFIXES):
                    ...
                    if current is not None:
                        ...
                        current_priority = SOURCE_PRIORITY.get(str(current["source_type"]), 0)
